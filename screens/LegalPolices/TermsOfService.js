...
const TermsOfService = () => {
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
      <Text style={styles.termsh1}>Terms of Service for Hadithi</Text>
      <Text style={{marginTop:20}}>Effective Date: June 17/2025</Text>
      <Text style={styles.termsh2}>1. Acceptance of Terms</Text>
      <Text style={styles.termsh3}>By accessing or using the Hadithi app, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you may not use our app.</Text>
      ...
      <Text style={styles.termsh3}>You retain ownership of the content you post on Hadithi. By uploading, submitting, or displaying content on the app, you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, and distribute the content.</Text>

      <Text style={styles.termsh2}>b. Prohibited Content:</Text>
      <Text style={styles.termsh3}>You may not post content that is illegal, harmful, sexual, threatening, abusive, defamatory, or violates the rights of others.</Text>

      <Text style={styles.termsh2}>4. App Usage Guidelines</Text>
      <Text style={styles.termsh2}>a. Compliance:</Text>
      <Text style={styles.termsh3}>You agree to comply with all applicable laws and regulations while using Hadithi.</Text>
      ...
      <Text style={styles.termsh3}>Our Privacy Policy outlines the types of information we collect, how we use it, and how it is shared. By using Hadithi, you agree to our Privacy Policy.</Text>


      <Text style={styles.termsh2}>6. Termination</Text>
      <Text style={styles.termsh3}>We reserve the right to terminate or suspend your account and access to Hadithi, with or without cause, at any time and without notice.</Text>
      ...
      <Text style={styles.termsh3}>Hadithi is provided "as is" without any warranties, expressed or implied. We do not warrant that the app will be error-free or uninterrupted.</Text>


      <Text style={styles.termsh2}>9. Limitation of Liability</Text>
      <Text style={styles.termsh3}>In no event shall Hadithi or its affiliates be liable for any indirect, incidental, special, or consequential damages arising out of or in any way connected with the use of Hadithi.</Text>
